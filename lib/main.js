 ...
 * @property {string|array} data - JSON or array of elements.
 * @property {string} data[].title - Title of an item.
 * @property {string} data[].url - href of an item.
